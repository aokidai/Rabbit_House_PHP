					...
					<?php
                      ...
                      if(isset($_POST["cboLoai"])){
					   ...
					   $name_tmp		=	$_FILES["txtHinh"]["tmp_name"];
						if($image!="")  
                       		$sql				=	"update  tblmon set idLoai=$idLoai, tenMon='$tenMon', gia=$gia,  hinhAnh ='$image', moTa='$moTa' where idMon=$idMon"; 
					   else
						     $sql		=	"update  tblmon set idLoai=$idLoai, tenMon='$tenMon', gia=$gia, moTa='$moTa' where idMon=$idMon"; 
					...
					<form method="post" enctype="multipart/form-data">
                     <table class="table table-striped table-bordered table-hover" style="width:90%" align="center">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                  <td>Mô tả</td>
                                                  <td><textarea name="txtMoTa" id="txtMoTa" rows="10" class="form-control" ><?=$moTa?></textarea>	</td>
                                                </tr>
                                                <tr>
                                                  <td>&nbsp;</td>

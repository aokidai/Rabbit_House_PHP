                                        ...
                                        <table class="table">
                                            ...
                                            <tbody
												<?php 
												    ...
												    $sql		=	"select * from tblkhachhang limit $pos, $pageSize";
												   	$rs 		=	mysqli_query($conn, $sql);
												   	$i			=	1;
												  while($row=mysqli_fetch_array($rs)){											  
													echo" <tr>
														...
														<td>".$row["SDT"]."</td>
														<td>".$row["username"]."</td>
														<td><a href='javascript:del_confirm(\"del_khachhang.php?id=".$row["idKhachhang"]."\")'>Xóa</a></td>
														</tr>";	
												   $i++;
												  }
												?>
                                                    ...
                                                    <th colspan="4">
													 <?php 
														...
														for($i=1; $i<=ceil($count/$pageSize);$i++)
															echo "<a href='list_khachhang.php?page=$i'>".$i."</a>&nbsp&nbsp";
													?>
											</th>

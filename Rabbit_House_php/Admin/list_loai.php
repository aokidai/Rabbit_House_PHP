        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">DANH SÁCH LOẠI MÓN</h1>
							<button type="button" class="btn btn-success" style="margin-bottom: 20px" onClick="javascript:window.location.href='insert_loai.php'">Thêm loại</button>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody
												<?php 
												    ...
												    $sql		=	"select * from tblloai limit $pos, $pageSize";
												   	$rs 		=	mysqli_query($conn, $sql);
												   	$i			=	1;
												  while($row=mysqli_fetch_array($rs)){											  
													echo" <tr>
														<td>$i</td>
														<td>".$row["tenLoai"]."</td>
														<td><a href='edit_loai.php?id=".$row["idLoai"]."'>Sửa</a></td>
														<td><a href='javascript:del_confirm(\"del_loai.php?id=".$row["idLoai"]."\")'>Xóa</a></td>
														</tr>";	
												   $i++;
												  }
												?>
                                                    ...
                                                    <th colspan="4">
													 <?php 
														...
														for($i=1; $i<=ceil($count/$pageSize);$i++)
															echo "<a href='list_loai.php?page=$i'>".$i."</a>&nbsp&nbsp";
													?>
											</th>

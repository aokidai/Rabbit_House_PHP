                ...
                <div class="container-fluid">
					...
					<?php
					 ...
					 if(isset($_POST["txtTenKH"])){
						...
						$soDT = $_POST["txtSDT"];
						$sql			=	"update tblkhachhang set tenKH= '$tenKH', SDT='$soDT' where idKhachhang=$id";
						...
						$id			=	$_GET["id"];
						$sql		=	"select * from tblkhachhang where idKhachhang=$id";						
						$rs 		=	mysqli_query($conn, $sql);
                     ...
                     <table class="table table-striped table-bordered table-hover" style="width:50%" align="center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input class="form-control" name="txtTenKH" value="<?=$tenKH?>"></td>
													<input  type="hidden" class="form-control" name="txtid" value="<?=$id?>">
                                                </tr>
												 <tr>
                                                    
                                                    <td>Số điện thoại:</td>
                                                    <td><input class="form-control" name="txtSDT" value="<?=$soDT?>"></td>
                                                </tr>
                                                <tr>
